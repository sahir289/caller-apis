...
import { createRecordsService } from "../records/recordsService.js";
  ...
  try {
    ...
    if (!SUPPORTED_FILE_TYPES.includes(ext)) {
      throw new BadRequestError(
        `Unsupported file format. Supported formats: ${SUPPORTED_FILE_TYPES.join(
          ", "
        )}`
      );
    }
    ...
    if (result) {
      // Store file info in DB using createRecordsService
